(ns torch.jit.TopLevelTracedModule
  ""
...
(defn TopLevelTracedModule 
  ""
  [ orig id_set _compilation_unit ]
  (py/call-attr jit "TopLevelTracedModule"  orig id_set _compilation_unit ))
