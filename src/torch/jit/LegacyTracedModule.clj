(ns torch.jit.LegacyTracedModule
  ""
...
(defn LegacyTracedModule 
  ""
  [inner & {:keys [force_outplace return_inputs return_inputs_states]
                       :or {force_outplace false return_inputs false return_inputs_states false}} ]
    (py/call-attr-kw jit "LegacyTracedModule" [inner] {:force_outplace force_outplace :return_inputs return_inputs :return_inputs_states return_inputs_states }))
