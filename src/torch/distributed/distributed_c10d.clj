(ns torch.distributed.distributed-c10d
  ""
...
(defn all-gather 
  ...
  [tensor_list tensor & {:keys [group async_op]
    ...
    (py/call-attr-kw distributed-c10d "all_gather" [tensor_list tensor] {:group group :async_op async_op }))
...
(defn all-gather-multigpu 
  ...
  [output_tensor_lists input_tensor_list & {:keys [group async_op]
                       :or {group <object object at 0x121e82100> async_op false}} ]
    (py/call-attr-kw distributed-c10d "all_gather_multigpu" [output_tensor_lists input_tensor_list] {:group group :async_op async_op }))
...
(defn all-reduce 
  ...
  [tensor & {:keys [op group async_op]
    ...
    (py/call-attr-kw distributed-c10d "all_reduce" [tensor] {:op op :group group :async_op async_op }))
...
(defn all-reduce-coalesced 
  ...
  [tensors & {:keys [op group async_op]
                       :or {op ReduceOp.SUM group <object object at 0x121e82100> async_op false}} ]
    (py/call-attr-kw distributed-c10d "all_reduce_coalesced" [tensors] {:op op :group group :async_op async_op }))
...
(defn all-reduce-multigpu 
  ...
  [tensor_list & {:keys [op group async_op]
                       :or {op ReduceOp.SUM group <object object at 0x121e82100> async_op false}} ]
    (py/call-attr-kw distributed-c10d "all_reduce_multigpu" [tensor_list] {:op op :group group :async_op async_op }))
...
(defn barrier 
  ...
  [ & {:keys [group async_op]
   ...
   (py/call-attr-kw distributed-c10d "barrier" [] {:group group :async_op async_op }))
...
(defn broadcast 
  ...
  [tensor src & {:keys [group async_op]
                       :or {group <object object at 0x121e82100> async_op false}} ]
    (py/call-attr-kw distributed-c10d "broadcast" [tensor src] {:group group :async_op async_op }))
...
(defn broadcast-multigpu 
  ...
  [tensor_list src & {:keys [group async_op src_tensor]
    ...
    (py/call-attr-kw distributed-c10d "broadcast_multigpu" [tensor_list src] {:group group :async_op async_op :src_tensor src_tensor }))
...
(defn destroy-process-group 
  ...
  [ & {:keys [group]
   ...
   (py/call-attr-kw distributed-c10d "destroy_process_group" [] {:group group }))
...
(defn gather 
  ...
  [tensor gather_list & {:keys [dst group async_op]
    ...
    (py/call-attr-kw distributed-c10d "gather" [tensor gather_list] {:dst dst :group group :async_op async_op }))
...
(defn get-backend 
  ...
  [ & {:keys [group]
   ...
   (py/call-attr-kw distributed-c10d "get_backend" [] {:group group }))
...
(defn get-rank 
  ...
  [ & {:keys [group]
   ...
   (py/call-attr-kw distributed-c10d "get_rank" [] {:group group }))
...
(defn get-world-size 
  ...
  [ & {:keys [group]
   ...
   (py/call-attr-kw distributed-c10d "get_world_size" [] {:group group }))
...
(defn init-process-group 
  ...
  [backend init_method & {:keys [timeout world_size rank store group_name]
    ...
    (py/call-attr-kw distributed-c10d "init_process_group" [backend init_method] {:timeout timeout :world_size world_size :rank rank :store store :group_name group_name }))
...
(defn irecv 
  ...
  [tensor src & {:keys [group tag]
    ...
    (py/call-attr-kw distributed-c10d "irecv" [tensor src] {:group group :tag tag }))
...
(defn is-gloo-available 
  "
    ...
    "
  [  ]
  (py/call-attr distributed-c10d "is_gloo_available"  ))
...
(defn is-initialized 
  "
    ...
    "
  [  ]
  (py/call-attr distributed-c10d "is_initialized"  ))
...
(defn is-mpi-available 
  "
    ...
    "
  [  ]
  (py/call-attr distributed-c10d "is_mpi_available"  ))
...
(defn is-nccl-available 
  "
    ...
    "
  [  ]
  (py/call-attr distributed-c10d "is_nccl_available"  ))
...
(defn isend 
  ...
  [tensor dst & {:keys [group tag]
                       :or {group <object object at 0x121e82100> tag 0}} ]
    (py/call-attr-kw distributed-c10d "isend" [tensor dst] {:group group :tag tag }))
...
(defn new-group 
  ...
  [ranks & {:keys [timeout backend]
                       :or {timeout 0:30:00}} ]
    (py/call-attr-kw distributed-c10d "new_group" [ranks] {:timeout timeout :backend backend }))
...
(defn recv 
  ...
  [tensor src & {:keys [group tag]
                       :or {group <object object at 0x121e82100> tag 0}} ]
    (py/call-attr-kw distributed-c10d "recv" [tensor src] {:group group :tag tag }))
...
(defn reduce 
  ...
  [tensor dst & {:keys [op group async_op]
                       :or {op ReduceOp.SUM group <object object at 0x121e82100> async_op false}} ]
    (py/call-attr-kw distributed-c10d "reduce" [tensor dst] {:op op :group group :async_op async_op }))
...
(defn reduce-multigpu 
  ...
  [tensor_list dst & {:keys [op group async_op dst_tensor]
    ...
    (py/call-attr-kw distributed-c10d "reduce_multigpu" [tensor_list dst] {:op op :group group :async_op async_op :dst_tensor dst_tensor }))
...
(defn reduce-scatter 
  ...
  [output input_list & {:keys [op group async_op]
                       :or {op ReduceOp.SUM group <object object at 0x121e82100> async_op false}} ]
    (py/call-attr-kw distributed-c10d "reduce_scatter" [output input_list] {:op op :group group :async_op async_op }))
...
(defn reduce-scatter-multigpu 
  ...
  [output_tensor_list input_tensor_lists & {:keys [op group async_op]
                       :or {op ReduceOp.SUM group <object object at 0x121e82100> async_op false}} ]
    (py/call-attr-kw distributed-c10d "reduce_scatter_multigpu" [output_tensor_list input_tensor_lists] {:op op :group group :async_op async_op }))
...
(defn register-rendezvous-handler 
  "Registers a new rendezvous handler.
    ...
    "
  [ scheme handler ]
  (py/call-attr distributed-c10d "register_rendezvous_handler"  scheme handler ))

(defn rendezvous 
  ""
  [ url ]
  (py/call-attr distributed-c10d "rendezvous"  url ))
...
(defn scatter 
  ...
  [tensor scatter_list & {:keys [src group async_op]
    ...
    (py/call-attr-kw distributed-c10d "scatter" [tensor scatter_list] {:src src :group group :async_op async_op }))
...
(defn send 
  ...
  [tensor dst & {:keys [group tag]
                       :or {group <object object at 0x121e82100> tag 0}} ]
    (py/call-attr-kw distributed-c10d "send" [tensor dst] {:group group :tag tag }))
