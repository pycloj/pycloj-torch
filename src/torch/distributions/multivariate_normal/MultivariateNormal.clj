(ns torch.distributions.multivariate-normal.MultivariateNormal
  "
...
(defn MultivariateNormal 
  ...
  (py/call-attr multivariate-normal "MultivariateNormal"  loc covariance_matrix precision_matrix scale_tril validate_args ))
