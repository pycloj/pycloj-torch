(ns torch.distributions.relaxed-bernoulli.TransformedDistribution
  "
...
(defn TransformedDistribution 
  ...
  (py/call-attr relaxed-bernoulli "TransformedDistribution"  base_distribution transforms validate_args ))
