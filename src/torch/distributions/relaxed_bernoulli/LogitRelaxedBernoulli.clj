(ns torch.distributions.relaxed-bernoulli.LogitRelaxedBernoulli
  "
...
(defn LogitRelaxedBernoulli 
  ...
  (py/call-attr relaxed-bernoulli "LogitRelaxedBernoulli"  temperature probs logits validate_args ))
