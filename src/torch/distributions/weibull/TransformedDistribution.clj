(ns torch.distributions.weibull.TransformedDistribution
  "
...
(py/initialize!)
(defonce weibull (import-module "torch.distributions.weibull"))
...
(defn TransformedDistribution 
  ...
  (py/call-attr weibull "TransformedDistribution"  base_distribution transforms validate_args ))
