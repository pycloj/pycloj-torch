(ns torch.distributions.multinomial.Multinomial
  "
...
(defn Multinomial 
  ...
  [ & {:keys [total_count probs logits validate_args]
   ...
   (py/call-attr-kw multinomial "Multinomial" [] {:total_count total_count :probs probs :logits logits :validate_args validate_args }))
