(ns torch.distributions.relaxed-categorical.TransformedDistribution
  "
...
(defn TransformedDistribution 
  ...
  (py/call-attr relaxed-categorical "TransformedDistribution"  base_distribution transforms validate_args ))
