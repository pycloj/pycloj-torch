(ns torch.distributions.relaxed-categorical.ExpRelaxedCategorical
  "
...
(defn ExpRelaxedCategorical 
  ...
  (py/call-attr relaxed-categorical "ExpRelaxedCategorical"  temperature probs logits validate_args ))
