(ns torch.distributions.logistic-normal.TransformedDistribution
  "
...
(py/initialize!)
(defonce logistic-normal (import-module "torch.distributions.logistic_normal"))
...
(defn TransformedDistribution 
  ...
  (py/call-attr logistic-normal "TransformedDistribution"  base_distribution transforms validate_args ))
