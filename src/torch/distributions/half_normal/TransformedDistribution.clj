(ns torch.distributions.half-normal.TransformedDistribution
  "
...
(py/initialize!)
(defonce half-normal (import-module "torch.distributions.half_normal"))
...
(defn TransformedDistribution 
  ...
  (py/call-attr half-normal "TransformedDistribution"  base_distribution transforms validate_args ))
