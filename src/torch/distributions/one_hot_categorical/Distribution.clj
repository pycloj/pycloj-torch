(ns torch.distributions.one-hot-categorical.Distribution
  "
...
(py/initialize!)
(defonce one-hot-categorical (import-module "torch.distributions.one_hot_categorical"))
...
(defn Distribution 
  ...
  [ & {:keys [batch_shape event_shape validate_args]
   ...
   (py/call-attr-kw one-hot-categorical "Distribution" [] {:batch_shape batch_shape :event_shape event_shape :validate_args validate_args }))
