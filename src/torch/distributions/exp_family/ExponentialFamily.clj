(ns torch.distributions.exp-family.ExponentialFamily
  "
...
(py/initialize!)
(defonce exp-family (import-module "torch.distributions.exp_family"))
...
(defn ExponentialFamily 
  ...
  [ & {:keys [batch_shape event_shape validate_args]
   ...
   (py/call-attr-kw exp-family "ExponentialFamily" [] {:batch_shape batch_shape :event_shape event_shape :validate_args validate_args }))
