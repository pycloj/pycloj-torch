(ns torch.distributions.negative-binomial.NegativeBinomial
  "
...
(defn NegativeBinomial 
  "
    ...
    Args:
        ...
        logits (Tensor): Event log-odds for probabilities of success
    "
  [ total_count probs logits validate_args ]
  (py/call-attr negative-binomial "NegativeBinomial"  total_count probs logits validate_args ))
