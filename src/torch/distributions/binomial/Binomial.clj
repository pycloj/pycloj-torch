(ns torch.distributions.binomial.Binomial
  "
...
(defn Binomial 
  ...
  [ & {:keys [total_count probs logits validate_args]
   ...
   (py/call-attr-kw binomial "Binomial" [] {:total_count total_count :probs probs :logits logits :validate_args validate_args }))
