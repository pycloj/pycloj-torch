(ns torch.distributions.binomial.Distribution
  "
...
(py/initialize!)
(defonce binomial (import-module "torch.distributions.binomial"))
...
(defn Distribution 
  ...
  [ & {:keys [batch_shape event_shape validate_args]
   ...
   (py/call-attr-kw binomial "Distribution" [] {:batch_shape batch_shape :event_shape event_shape :validate_args validate_args }))
