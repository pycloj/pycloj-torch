(ns torch.distributions.distribution.Distribution
  "
...
(defn Distribution 
  ...
  [ & {:keys [batch_shape event_shape validate_args]
   ...
   (py/call-attr-kw distribution "Distribution" [] {:batch_shape batch_shape :event_shape event_shape :validate_args validate_args }))
