(ns torch.distributions.categorical.Distribution
  "
...
(py/initialize!)
(defonce categorical (import-module "torch.distributions.categorical"))
...
(defn Distribution 
  ...
  [ & {:keys [batch_shape event_shape validate_args]
   ...
   (py/call-attr-kw categorical "Distribution" [] {:batch_shape batch_shape :event_shape event_shape :validate_args validate_args }))
