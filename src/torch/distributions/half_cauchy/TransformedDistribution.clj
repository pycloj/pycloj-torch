(ns torch.distributions.half-cauchy.TransformedDistribution
  "
...
(py/initialize!)
(defonce half-cauchy (import-module "torch.distributions.half_cauchy"))
...
(defn TransformedDistribution 
  ...
  (py/call-attr half-cauchy "TransformedDistribution"  base_distribution transforms validate_args ))
