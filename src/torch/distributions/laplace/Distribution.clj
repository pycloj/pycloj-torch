(ns torch.distributions.laplace.Distribution
  "
...
(py/initialize!)
(defonce laplace (import-module "torch.distributions.laplace"))
...
(defn Distribution 
  ...
  [ & {:keys [batch_shape event_shape validate_args]
   ...
   (py/call-attr-kw laplace "Distribution" [] {:batch_shape batch_shape :event_shape event_shape :validate_args validate_args }))
