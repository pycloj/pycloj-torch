(ns torch.distributions.bernoulli.ExponentialFamily
  "
...
(defn ExponentialFamily 
  ...
  [ & {:keys [batch_shape event_shape validate_args]
   ...
   (py/call-attr-kw bernoulli "ExponentialFamily" [] {:batch_shape batch_shape :event_shape event_shape :validate_args validate_args }))
