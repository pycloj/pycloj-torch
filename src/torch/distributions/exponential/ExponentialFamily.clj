(ns torch.distributions.exponential.ExponentialFamily
  "
...
(defn ExponentialFamily 
  ...
  [ & {:keys [batch_shape event_shape validate_args]
   ...
   (py/call-attr-kw exponential "ExponentialFamily" [] {:batch_shape batch_shape :event_shape event_shape :validate_args validate_args }))
