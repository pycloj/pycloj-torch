(ns torch.distributions.Distribution
  "
...
(defn Distribution 
  ...
  [ & {:keys [batch_shape event_shape validate_args]
   ...
   (py/call-attr-kw distributions "Distribution" [] {:batch_shape batch_shape :event_shape event_shape :validate_args validate_args }))
