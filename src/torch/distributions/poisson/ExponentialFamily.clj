(ns torch.distributions.poisson.ExponentialFamily
  "
...
(py/initialize!)
(defonce poisson (import-module "torch.distributions.poisson"))
...
(defn ExponentialFamily 
  ...
  [ & {:keys [batch_shape event_shape validate_args]
   ...
   (py/call-attr-kw poisson "ExponentialFamily" [] {:batch_shape batch_shape :event_shape event_shape :validate_args validate_args }))
