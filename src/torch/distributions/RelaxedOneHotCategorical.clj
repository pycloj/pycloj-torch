(ns torch.distributions.RelaxedOneHotCategorical
  "
...
(defn RelaxedOneHotCategorical 
  ...
  (py/call-attr distributions "RelaxedOneHotCategorical"  temperature probs logits validate_args ))
