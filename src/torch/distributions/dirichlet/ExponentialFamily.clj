(ns torch.distributions.dirichlet.ExponentialFamily
  "
...
(py/initialize!)
(defonce dirichlet (import-module "torch.distributions.dirichlet"))
...
(defn ExponentialFamily 
  ...
  [ & {:keys [batch_shape event_shape validate_args]
   ...
   (py/call-attr-kw dirichlet "ExponentialFamily" [] {:batch_shape batch_shape :event_shape event_shape :validate_args validate_args }))
