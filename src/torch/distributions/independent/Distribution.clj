(ns torch.distributions.independent.Distribution
  "
...
(defn Distribution 
  ...
  [ & {:keys [batch_shape event_shape validate_args]
   ...
   (py/call-attr-kw independent "Distribution" [] {:batch_shape batch_shape :event_shape event_shape :validate_args validate_args }))
