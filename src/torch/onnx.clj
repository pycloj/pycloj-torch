...
(defn export 
  "
    ...
    "
  [model args f & {:keys [export_params verbose training input_names output_names aten export_raw_ir operator_export_type opset_version _retain_param_name do_constant_folding example_outputs strip_doc_string dynamic_axes keep_initializers_as_inputs]
                       :or {export_params true verbose false training false aten false export_raw_ir false _retain_param_name true do_constant_folding false strip_doc_string true}} ]
    (py/call-attr-kw onnx "export" [model args f] {:export_params export_params :verbose verbose :training training :input_names input_names :output_names output_names :aten aten :export_raw_ir export_raw_ir :operator_export_type operator_export_type :opset_version opset_version :_retain_param_name _retain_param_name :do_constant_folding do_constant_folding :example_outputs example_outputs :strip_doc_string strip_doc_string :dynamic_axes dynamic_axes :keep_initializers_as_inputs keep_initializers_as_inputs }))

(defn export-to-pretty-string 
  ""
  [  ]
  (py/call-attr onnx "export_to_pretty_string"  ))

(defn is-in-onnx-export 
  "
    ...
    "
  [  ]
  (py/call-attr onnx "is_in_onnx_export"  ))

(defn register-custom-op-symbolic 
  ""
  [ symbolic_name symbolic_fn opset_version ]
  (py/call-attr onnx "register_custom_op_symbolic"  symbolic_name symbolic_fn opset_version ))
...
(defn set-training 
  "
    ...
    "
  [ model mode ]
  (py/call-attr onnx "set_training"  model mode ))
