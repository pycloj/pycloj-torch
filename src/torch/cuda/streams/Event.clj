...
(py/initialize!)
(defonce streams (import-module "torch.cuda.streams"))
...
(defn Event 
  ...
  [ & {:keys [enable_timing blocking interprocess]
   ...
   (py/call-attr-kw streams "Event" [] {:enable_timing enable_timing :blocking blocking :interprocess interprocess }))
