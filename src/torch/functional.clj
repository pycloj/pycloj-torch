...
(defn align-tensors 
  ""
  [  ]
  (py/call-attr functional "align_tensors"  ))
...
(defn broadcast-tensors 
  "broadcast_tensors(*tensors) -> List of Tensors
    ...
    "
  [  ]
  (py/call-attr functional "broadcast_tensors"  ))
...
(defn cartesian-prod 
  "Do cartesian product of the given sequence of tensors. The behavior is similar to
    ...
    "
  [  ]
  (py/call-attr functional "cartesian_prod"  ))
...
(defn chain-matmul 
  "Returns the matrix product of the :math:`N` 2-D tensors. This product is efficiently computed
    ...
    "
  [  ]
  (py/call-attr functional "chain_matmul"  ))
...
"
  [ equation ]
  (py/call-attr functional "einsum"  equation ))
...
(defn isfinite 
  "Returns a new tensor with boolean elements representing if each element is `Finite` or not.
    ...
    "
  [ tensor ]
  (py/call-attr functional "isfinite"  tensor ))
...
(defn isinf 
  "Returns a new tensor with boolean elements representing if each element is `+/-INF` or not.
    ...
    "
  [ tensor ]
  (py/call-attr functional "isinf"  tensor ))
...
(defn lu 
  ...
  [A & {:keys [pivot get_infos out]
    ...
    (py/call-attr-kw functional "lu" [A] {:pivot pivot :get_infos get_infos :out out }))
...
(defn lu-unpack 
  ...
  [LU_data LU_pivots & {:keys [unpack_data unpack_pivots]
    ...
    (py/call-attr-kw functional "lu_unpack" [LU_data LU_pivots] {:unpack_data unpack_data :unpack_pivots unpack_pivots }))
...
expanding the :math:`i` :sup:`th` input over dimensions defined by other inputs.
    ...
    "
  [  ]
  (py/call-attr functional "meshgrid"  ))
...
(defn norm 
  ...
  [input & {:keys [p dim keepdim out dtype]
    ...
    (py/call-attr-kw functional "norm" [input] {:p p :dim dim :keepdim keepdim :out out :dtype dtype }))
...
(defn split 
  ...
  [tensor split_size_or_sections & {:keys [dim]
                       :or {dim 0}} ]
    (py/call-attr-kw functional "split" [tensor split_size_or_sections] {:dim dim }))
...
(defn stft 
  ...
  [input n_fft hop_length win_length window & {:keys [center pad_mode normalized onesided]
    ...
    (py/call-attr-kw functional "stft" [input n_fft hop_length win_length window] {:center center :pad_mode pad_mode :normalized normalized :onesided onesided }))
...
(defn tensordot 
  ...
  [a b & {:keys [dims]
                       :or {dims 2}} ]
    (py/call-attr-kw functional "tensordot" [a b] {:dims dims }))
...
(defn unique 
  ...
  [input & {:keys [sorted return_inverse return_counts dim]
    ...
    (py/call-attr-kw functional "unique" [input] {:sorted sorted :return_inverse return_inverse :return_counts return_counts :dim dim }))
...
(defn unique-consecutive 
  ...
  [input & {:keys [return_inverse return_counts dim]
    ...
    (py/call-attr-kw functional "unique_consecutive" [input] {:return_inverse return_inverse :return_counts return_counts :dim dim }))
