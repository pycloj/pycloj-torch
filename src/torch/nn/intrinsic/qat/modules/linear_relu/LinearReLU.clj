(ns torch.nn.intrinsic.qat.modules.linear-relu.LinearReLU
  "
...
(py/initialize!)
(defonce linear-relu (import-module "torch.nn.intrinsic.qat.modules.linear_relu"))
...
(defn LinearReLU 
  "
    ...
    Examples::
        ...
        torch.Size([128, 30])
    "
  [in_features out_features & {:keys [bias qconfig]
                       :or {bias true}} ]
    (py/call-attr-kw linear-relu "LinearReLU" [in_features out_features] {:bias bias :qconfig qconfig }))
