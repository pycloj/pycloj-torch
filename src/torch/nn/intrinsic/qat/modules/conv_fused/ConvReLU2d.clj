(ns torch.nn.intrinsic.qat.modules.conv-fused.ConvReLU2d
  "
...
(defn ConvReLU2d 
  ...
  [in_channels out_channels kernel_size & {:keys [stride padding dilation groups bias padding_mode qconfig]
    ...
    (py/call-attr-kw conv-fused "ConvReLU2d" [in_channels out_channels kernel_size] {:stride stride :padding padding :dilation dilation :groups groups :bias bias :padding_mode padding_mode :qconfig qconfig }))
