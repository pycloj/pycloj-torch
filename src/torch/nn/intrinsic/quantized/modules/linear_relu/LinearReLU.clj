(ns torch.nn.intrinsic.quantized.modules.linear-relu.LinearReLU
  "
...
(py/initialize!)
(defonce linear-relu (import-module "torch.nn.intrinsic.quantized.modules.linear_relu"))
...
(defn LinearReLU 
  "
    ...
    Examples::
        ...
        torch.Size([128, 30])
    "
  [in_features out_features & {:keys [bias]
                       :or {bias true}} ]
    (py/call-attr-kw linear-relu "LinearReLU" [in_features out_features] {:bias bias }))
