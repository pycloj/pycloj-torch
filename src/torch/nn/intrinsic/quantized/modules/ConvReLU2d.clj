(ns torch.nn.intrinsic.quantized.modules.ConvReLU2d
  "
...
(py/initialize!)
(defonce modules (import-module "torch.nn.intrinsic.quantized.modules"))
...
(defn ConvReLU2d 
  "
    ...
    "
  [in_channels out_channels kernel_size & {:keys [stride padding dilation groups bias padding_mode]
                       :or {stride 1 padding 0 dilation 1 groups 1 bias true padding_mode "zeros"}} ]
    (py/call-attr-kw modules "ConvReLU2d" [in_channels out_channels kernel_size] {:stride stride :padding padding :dilation dilation :groups groups :bias bias :padding_mode padding_mode }))
...
(defn set-weight-bias 
  ""
  [ self w b ]
  (py/call-attr self "set_weight_bias"  self w b ))
