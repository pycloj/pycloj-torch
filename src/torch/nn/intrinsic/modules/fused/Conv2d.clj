(ns torch.nn.intrinsic.modules.fused.Conv2d
...
(py/initialize!)
(defonce fused (import-module "torch.nn.intrinsic.modules.fused"))
...
(defn Conv2d 
  ...
  [in_channels out_channels kernel_size & {:keys [stride padding dilation groups bias padding_mode]
    ...
    (py/call-attr-kw fused "Conv2d" [in_channels out_channels kernel_size] {:stride stride :padding padding :dilation dilation :groups groups :bias bias :padding_mode padding_mode }))
