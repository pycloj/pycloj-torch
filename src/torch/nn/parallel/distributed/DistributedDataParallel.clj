(ns torch.nn.parallel.distributed.DistributedDataParallel
...
(defn DistributedDataParallel 
  ...
  [module device_ids output_device & {:keys [dim broadcast_buffers process_group bucket_cap_mb find_unused_parameters check_reduction]
    ...
    (py/call-attr-kw distributed "DistributedDataParallel" [module device_ids output_device] {:dim dim :broadcast_buffers broadcast_buffers :process_group process_group :bucket_cap_mb bucket_cap_mb :find_unused_parameters find_unused_parameters :check_reduction check_reduction }))
