(ns torch.nn.parallel.scatter-gather.Gather
  ""
...
(defn backward 
  ...
  (py/call-attr self "backward"  self ctx grad_output ))

(defn forward 
  ""
  [ self ctx target_device dim ]
  (py/call-attr self "forward"  self ctx target_device dim ))
