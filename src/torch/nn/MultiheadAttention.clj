(ns torch.nn.MultiheadAttention
...
(defn MultiheadAttention 
  ...
  [embed_dim num_heads & {:keys [dropout bias add_bias_kv add_zero_attn kdim vdim]
    ...
    (py/call-attr-kw nn "MultiheadAttention" [embed_dim num_heads] {:dropout dropout :bias bias :add_bias_kv add_bias_kv :add_zero_attn add_zero_attn :kdim kdim :vdim vdim }))
