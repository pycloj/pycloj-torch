...
(defn Embedding 
  ...
  [num_embeddings embedding_dim padding_idx max_norm & {:keys [norm_type scale_grad_by_freq sparse _weight]
    ...
    (py/call-attr-kw nn "Embedding" [num_embeddings embedding_dim padding_idx max_norm] {:norm_type norm_type :scale_grad_by_freq scale_grad_by_freq :sparse sparse :_weight _weight }))
