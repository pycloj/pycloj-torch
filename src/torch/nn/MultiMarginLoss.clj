...
(defn MultiMarginLoss 
  ...
  [ & {:keys [p margin weight size_average reduce reduction]
   ...
   (py/call-attr-kw nn "MultiMarginLoss" [] {:p p :margin margin :weight weight :size_average size_average :reduce reduce :reduction reduction }))
