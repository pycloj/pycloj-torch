...
(defn EmbeddingBag 
  ...
  [num_embeddings embedding_dim max_norm & {:keys [norm_type scale_grad_by_freq mode sparse _weight]
    ...
    (py/call-attr-kw nn "EmbeddingBag" [num_embeddings embedding_dim max_norm] {:norm_type norm_type :scale_grad_by_freq scale_grad_by_freq :mode mode :sparse sparse :_weight _weight }))
