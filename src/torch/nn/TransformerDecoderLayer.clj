(ns torch.nn.TransformerDecoderLayer
...
(defn TransformerDecoderLayer 
  ...
  [d_model nhead & {:keys [dim_feedforward dropout activation]
    ...
    (py/call-attr-kw nn "TransformerDecoderLayer" [d_model nhead] {:dim_feedforward dim_feedforward :dropout dropout :activation activation }))
