...
(defn SyncBatchNorm 
  ...
  [num_features & {:keys [eps momentum affine track_running_stats process_group]
    ...
    (py/call-attr-kw nn "SyncBatchNorm" [num_features] {:eps eps :momentum momentum :affine affine :track_running_stats track_running_stats :process_group process_group }))
