(ns torch.nn.quantized.modules.activation.ReLU6
...
(py/initialize!)
(defonce activation (import-module "torch.nn.quantized.modules.activation"))
...
(defn ReLU6 
  ...
  [ & {:keys [inplace]
   ...
   (py/call-attr-kw activation "ReLU6" [] {:inplace inplace }))
