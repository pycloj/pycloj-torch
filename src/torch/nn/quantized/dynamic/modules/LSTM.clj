(ns torch.nn.quantized.dynamic.modules.LSTM
  ""
...
(py/initialize!)
(defonce modules (import-module "torch.nn.quantized.dynamic.modules"))

(defn LSTM 
  ""
  [  ]
  (py/call-attr modules "LSTM"  ))
...
(defn forward-impl 
  ""
  [ self input hx batch_sizes max_batch_size sorted_indices ]
  (py/call-attr self "forward_impl"  self input hx batch_sizes max_batch_size sorted_indices ))

(defn forward-packed 
  ""
  [ self input hx ]
  (py/call-attr self "forward_packed"  self input hx ))

(defn forward-tensor 
  ""
  [ self input hx ]
  (py/call-attr self "forward_tensor"  self input hx ))
