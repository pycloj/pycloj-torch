(ns torch.nn.quantized.dynamic.modules.linear.Linear
  "
...
(py/initialize!)
(defonce linear (import-module "torch.nn.quantized.dynamic.modules.linear"))
...
(defn Linear 
  "
    ...
    Examples::
        ...
        torch.Size([128, 30])
    "
  [in_features out_features & {:keys [bias_]
                       :or {bias_ true}} ]
    (py/call-attr-kw linear "Linear" [in_features out_features] {:bias_ bias_ }))
