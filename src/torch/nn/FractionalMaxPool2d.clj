(ns torch.nn.FractionalMaxPool2d
...
(defn FractionalMaxPool2d 
  ...
  [kernel_size output_size output_ratio & {:keys [return_indices _random_samples]
    ...
    (py/call-attr-kw nn "FractionalMaxPool2d" [kernel_size output_size output_ratio] {:return_indices return_indices :_random_samples _random_samples }))
