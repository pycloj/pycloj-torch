(ns torch.nn.modules.activation.PReLU
...
(defn PReLU 
  "Applies the element-wise function:
    ...
    Examples::
        ...
        >>> output = m(input)
    "
  [ & {:keys [num_parameters init]
       :or {num_parameters 1 init 0.25}} ]
  
   (py/call-attr-kw activation "PReLU" [] {:num_parameters num_parameters :init init }))
