(ns torch.nn.modules.activation.Hardtanh
...
(defn Hardtanh 
  "Applies the HardTanh function element-wise
    ...
    Examples::
        ...
        >>> output = m(input)
    "
  [ & {:keys [min_val max_val inplace min_value max_value]
       :or {min_val -1.0 max_val 1.0 inplace false}} ]
  
   (py/call-attr-kw activation "Hardtanh" [] {:min_val min_val :max_val max_val :inplace inplace :min_value min_value :max_value max_value }))
