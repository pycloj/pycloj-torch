(ns torch.nn.modules.activation.RReLU
...
(defn RReLU 
  "Applies the randomized leaky rectified liner unit function, element-wise,
    ...
    .. _`Empirical Evaluation of Rectified Activations in Convolutional Network`:
        https://arxiv.org/abs/1505.00853
    "
  [ & {:keys [lower upper inplace]
       :or {lower 0.125 upper 0.3333333333333333 inplace false}} ]
  
   (py/call-attr-kw activation "RReLU" [] {:lower lower :upper upper :inplace inplace }))
