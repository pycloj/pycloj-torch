...
(defn RNNBase 
  ...
  [mode input_size hidden_size & {:keys [num_layers bias batch_first dropout bidirectional]
    ...
    (py/call-attr-kw modules "RNNBase" [mode input_size hidden_size] {:num_layers num_layers :bias bias :batch_first batch_first :dropout dropout :bidirectional bidirectional }))
