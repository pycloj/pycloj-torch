(ns torch.nn.modules.pooling.LPPool2d
...
(defn LPPool2d 
  "Applies a 2D power-average pooling over an input signal composed of several input
    ...
    "
  [norm_type kernel_size stride & {:keys [ceil_mode]
                       :or {ceil_mode false}} ]
    (py/call-attr-kw pooling "LPPool2d" [norm_type kernel_size stride] {:ceil_mode ceil_mode }))
