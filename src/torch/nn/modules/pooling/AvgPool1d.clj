(ns torch.nn.modules.pooling.AvgPool1d
...
(defn AvgPool1d 
  "Applies a 1D average pooling over an input signal composed of several
    ...
    Examples::
        ...
        tensor([[[ 2.,  4.,  6.]]])
    "
  [kernel_size stride & {:keys [padding ceil_mode count_include_pad]
                       :or {padding 0 ceil_mode false count_include_pad true}} ]
    (py/call-attr-kw pooling "AvgPool1d" [kernel_size stride] {:padding padding :ceil_mode ceil_mode :count_include_pad count_include_pad }))
