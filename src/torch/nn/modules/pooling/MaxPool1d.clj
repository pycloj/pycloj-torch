(ns torch.nn.modules.pooling.MaxPool1d
...
(defn MaxPool1d 
  ...
  [kernel_size stride & {:keys [padding dilation return_indices ceil_mode]
    ...
    (py/call-attr-kw pooling "MaxPool1d" [kernel_size stride] {:padding padding :dilation dilation :return_indices return_indices :ceil_mode ceil_mode }))
