(ns torch.nn.modules.pooling.FractionalMaxPool3d
...
(py/initialize!)
(defonce pooling (import-module "torch.nn.modules.pooling"))

(defn FractionalMaxPool3d 
  "Applies a 3D fractional max pooling over an input signal composed of several input planes.
    ...
    .. _Fractional MaxPooling:
        http://arxiv.org/abs/1412.6071
    "
  [kernel_size output_size output_ratio & {:keys [return_indices _random_samples]
                       :or {return_indices false}} ]
    (py/call-attr-kw pooling "FractionalMaxPool3d" [kernel_size output_size output_ratio] {:return_indices return_indices :_random_samples _random_samples }))
