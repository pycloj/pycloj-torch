(ns torch.nn.modules.pooling.AvgPool3d
...
(defn AvgPool3d 
  "Applies a 3D average pooling over an input signal composed of several input
    ...
    Examples::
        ...
        >>> output = m(input)
    "
  [kernel_size stride & {:keys [padding ceil_mode count_include_pad divisor_override]
                       :or {padding 0 ceil_mode false count_include_pad true}} ]
    (py/call-attr-kw pooling "AvgPool3d" [kernel_size stride] {:padding padding :ceil_mode ceil_mode :count_include_pad count_include_pad :divisor_override divisor_override }))
