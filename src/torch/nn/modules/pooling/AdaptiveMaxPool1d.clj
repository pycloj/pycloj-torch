(ns torch.nn.modules.pooling.AdaptiveMaxPool1d
...
(defn AdaptiveMaxPool1d 
  "Applies a 1D adaptive max pooling over an input signal composed of several input planes.
    ...
    "
  [output_size & {:keys [return_indices]
                       :or {return_indices false}} ]
    (py/call-attr-kw pooling "AdaptiveMaxPool1d" [output_size] {:return_indices return_indices }))
