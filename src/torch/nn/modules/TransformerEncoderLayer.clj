(ns torch.nn.modules.TransformerEncoderLayer
...
(defn TransformerEncoderLayer 
  ...
  [d_model nhead & {:keys [dim_feedforward dropout activation]
    ...
    (py/call-attr-kw modules "TransformerEncoderLayer" [d_model nhead] {:dim_feedforward dim_feedforward :dropout dropout :activation activation }))
