(ns torch.nn.modules.loss.HingeEmbeddingLoss
...
(defn HingeEmbeddingLoss 
  ...
  [ & {:keys [margin size_average reduce reduction]
   ...
   (py/call-attr-kw loss "HingeEmbeddingLoss" [] {:margin margin :size_average size_average :reduce reduce :reduction reduction }))
