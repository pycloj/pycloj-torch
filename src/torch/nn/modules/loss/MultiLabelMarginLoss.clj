(ns torch.nn.modules.loss.MultiLabelMarginLoss
...
(defn MultiLabelMarginLoss 
  "Creates a criterion that optimizes a multi-class multi-classification
    ...
    "
  [size_average reduce & {:keys [reduction]
                       :or {reduction "mean"}} ]
    (py/call-attr-kw loss "MultiLabelMarginLoss" [size_average reduce] {:reduction reduction }))
