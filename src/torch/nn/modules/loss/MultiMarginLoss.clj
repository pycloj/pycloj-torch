(ns torch.nn.modules.loss.MultiMarginLoss
  ...
  "Creates a criterion that optimizes a multi-class classification hinge
    ...
    Args:
        ...
        reduction (string, optional): Specifies the reduction to apply to the output:
            ...
            specifying either of those two args will override :attr:`reduction`. Default: ``'mean'``
    "
  [ & {:keys [p margin weight size_average reduce reduction]
       :or {p 1 margin 1.0 reduction "mean"}} ]
  
   (py/call-attr-kw loss "MultiMarginLoss" [] {:p p :margin margin :weight weight :size_average size_average :reduce reduce :reduction reduction }))
