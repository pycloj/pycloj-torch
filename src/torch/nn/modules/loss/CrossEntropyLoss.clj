(ns torch.nn.modules.loss.CrossEntropyLoss
...
(defn CrossEntropyLoss 
  "This criterion combines :func:`nn.LogSoftmax` and :func:`nn.NLLLoss` in one single class.
    ...
    Examples::
        ...
        >>> output.backward()
    "
  [weight size_average & {:keys [ignore_index reduce reduction]
                       :or {ignore_index -100 reduction "mean"}} ]
    (py/call-attr-kw loss "CrossEntropyLoss" [weight size_average] {:ignore_index ignore_index :reduce reduce :reduction reduction }))
