(ns torch.nn.modules.loss.MarginRankingLoss
...
(defn MarginRankingLoss 
  ...
  [ & {:keys [margin size_average reduce reduction]
   ...
   (py/call-attr-kw loss "MarginRankingLoss" [] {:margin margin :size_average size_average :reduce reduce :reduction reduction }))
