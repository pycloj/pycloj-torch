(ns torch.nn.modules.pixelshuffle.PixelShuffle
...
(py/initialize!)
(defonce pixelshuffle (import-module "torch.nn.modules.pixelshuffle"))
...
(defn PixelShuffle 
  "Rearranges elements in a tensor of shape :math:`(*, C \times r^2, H, W)`
    ...
    "
  [ upscale_factor ]
  (py/call-attr pixelshuffle "PixelShuffle"  upscale_factor ))
