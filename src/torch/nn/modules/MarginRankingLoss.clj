(ns torch.nn.modules.MarginRankingLoss
...
(defn MarginRankingLoss 
  ...
  [ & {:keys [margin size_average reduce reduction]
   ...
   (py/call-attr-kw modules "MarginRankingLoss" [] {:margin margin :size_average size_average :reduce reduce :reduction reduction }))
