(ns torch.nn.modules.distance.PairwiseDistance
  "
...
(py/initialize!)
(defonce distance (import-module "torch.nn.modules.distance"))

(defn PairwiseDistance 
  "
    Computes the batchwise pairwise distance between vectors :math:`v_1`, :math:`v_2` using the p-norm:
  ...
  [ & {:keys [p eps keepdim]
   ...
   (py/call-attr-kw distance "PairwiseDistance" [] {:p p :eps eps :keepdim keepdim }))
...
(defn forward 
  ""
  [ self x1 x2 ]
  (py/call-attr self "forward"  self x1 x2 ))
