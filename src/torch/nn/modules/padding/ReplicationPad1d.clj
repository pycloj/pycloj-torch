(ns torch.nn.modules.padding.ReplicationPad1d
...
(py/initialize!)
(defonce padding (import-module "torch.nn.modules.padding"))

(defn ReplicationPad1d 
  "Pads the input tensor using replication of the input boundary.
    ...
    "
  [ padding ]
  (py/call-attr padding "ReplicationPad1d"  padding ))
