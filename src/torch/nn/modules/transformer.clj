(ns torch.nn.modules.Transformer
...
(defn Transformer 
  ...
  [ & {:keys [d_model nhead num_encoder_layers num_decoder_layers dim_feedforward dropout activation custom_encoder custom_decoder]
   ...
   (py/call-attr-kw modules "Transformer" [] {:d_model d_model :nhead nhead :num_encoder_layers num_encoder_layers :num_decoder_layers num_decoder_layers :dim_feedforward dim_feedforward :dropout dropout :activation activation :custom_encoder custom_encoder :custom_decoder custom_decoder }))
