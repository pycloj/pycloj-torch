(ns torch.nn.modules.HingeEmbeddingLoss
...
(defn HingeEmbeddingLoss 
  ...
  [ & {:keys [margin size_average reduce reduction]
   ...
   (py/call-attr-kw modules "HingeEmbeddingLoss" [] {:margin margin :size_average size_average :reduce reduce :reduction reduction }))
