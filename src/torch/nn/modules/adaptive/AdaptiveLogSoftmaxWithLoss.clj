(ns torch.nn.modules.adaptive.AdaptiveLogSoftmaxWithLoss
...
(defn AdaptiveLogSoftmaxWithLoss 
  ...
  [in_features n_classes cutoffs & {:keys [div_value head_bias]
    ...
    (py/call-attr-kw adaptive "AdaptiveLogSoftmaxWithLoss" [in_features n_classes cutoffs] {:div_value div_value :head_bias head_bias }))
