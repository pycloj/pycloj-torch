(ns torch.nn.modules.transformer.MultiheadAttention
...
(defn MultiheadAttention 
  "Allows the model to jointly attend to information
    ...
    Examples::
        ...
        >>> attn_output, attn_output_weights = multihead_attn(query, key, value)
    "
  [embed_dim num_heads & {:keys [dropout bias add_bias_kv add_zero_attn kdim vdim]
                       :or {dropout 0.0 bias true add_bias_kv false add_zero_attn false}} ]
    (py/call-attr-kw transformer "MultiheadAttention" [embed_dim num_heads] {:dropout dropout :bias bias :add_bias_kv add_bias_kv :add_zero_attn add_zero_attn :kdim kdim :vdim vdim }))
...
(defn forward 
  "
    ...
    Shape:
        ...
        "
  [self query key value key_padding_mask & {:keys [need_weights attn_mask]
                       :or {need_weights true}} ]
    (py/call-attr-kw self "forward" [query key value key_padding_mask] {:need_weights need_weights :attn_mask attn_mask }))
