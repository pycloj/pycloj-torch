(ns torch.nn.modules.transformer.TransformerEncoder
...
(defn TransformerEncoder 
  ...
  (py/call-attr transformer "TransformerEncoder"  encoder_layer num_layers norm ))
...
(defn forward 
  "Pass the input through the endocder layers in turn.
        ...
        "
  [ self src mask src_key_padding_mask ]
  (py/call-attr self "forward"  self src mask src_key_padding_mask ))
