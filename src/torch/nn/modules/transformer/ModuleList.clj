(ns torch.nn.modules.transformer.ModuleList
...
(defn ModuleList 
  "Holds submodules in a list.
    ...
    "
  [ modules ]
  (py/call-attr transformer "ModuleList"  modules ))
...
(defn append 
  "Appends a given module to the end of the list.
        ...
        "
  [ self module ]
  (py/call-attr self "append"  self module ))
...
(defn extend 
  "Appends modules from a Python iterable to the end of the list.
        ...
        "
  [ self modules ]
  (py/call-attr self "extend"  self modules ))
...
(defn insert 
  "Insert a given module before a given index in the list.
        ...
        "
  [ self index module ]
  (py/call-attr self "insert"  self index module ))
