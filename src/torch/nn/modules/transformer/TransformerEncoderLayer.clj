(ns torch.nn.modules.transformer.TransformerEncoderLayer
...
(defn TransformerEncoderLayer 
  ...
  [d_model nhead & {:keys [dim_feedforward dropout activation]
    ...
    (py/call-attr-kw transformer "TransformerEncoderLayer" [d_model nhead] {:dim_feedforward dim_feedforward :dropout dropout :activation activation }))
...
(defn forward 
  ...
  (py/call-attr self "forward"  self src src_mask src_key_padding_mask ))
