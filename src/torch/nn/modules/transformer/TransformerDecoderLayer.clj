(ns torch.nn.modules.transformer.TransformerDecoderLayer
...
(defn TransformerDecoderLayer 
  "TransformerDecoderLayer is made up of self-attn, multi-head-attn and feedforward network.
    ...
    Examples::
        ...
        >>> out = decoder_layer(tgt, memory)
    "
  [d_model nhead & {:keys [dim_feedforward dropout activation]
                       :or {dim_feedforward 2048 dropout 0.1 activation "relu"}} ]
    (py/call-attr-kw transformer "TransformerDecoderLayer" [d_model nhead] {:dim_feedforward dim_feedforward :dropout dropout :activation activation }))
...
(defn forward 
  "Pass the inputs (and mask) through the decoder layer.
        ...
        "
  [ self tgt memory tgt_mask memory_mask tgt_key_padding_mask memory_key_padding_mask ]
  (py/call-attr self "forward"  self tgt memory tgt_mask memory_mask tgt_key_padding_mask memory_key_padding_mask ))
