(ns torch.nn.modules.rnn.RNNBase
  ""
...
(defn RNNBase 
  ""
  [mode input_size hidden_size & {:keys [num_layers bias batch_first dropout bidirectional]
                       :or {num_layers 1 bias true batch_first false dropout 0.0 bidirectional false}} ]
    (py/call-attr-kw rnn "RNNBase" [mode input_size hidden_size] {:num_layers num_layers :bias bias :batch_first batch_first :dropout dropout :bidirectional bidirectional }))
