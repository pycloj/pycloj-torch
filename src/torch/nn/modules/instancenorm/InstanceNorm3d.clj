(ns torch.nn.modules.instancenorm.InstanceNorm3d
...
(defn InstanceNorm3d 
  ...
  [num_features & {:keys [eps momentum affine track_running_stats]
    ...
    (py/call-attr-kw instancenorm "InstanceNorm3d" [num_features] {:eps eps :momentum momentum :affine affine :track_running_stats track_running_stats }))
