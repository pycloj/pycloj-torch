(ns torch.nn.modules.instancenorm.InstanceNorm1d
...
(py/initialize!)
(defonce instancenorm (import-module "torch.nn.modules.instancenorm"))
...
(defn InstanceNorm1d 
  "Applies Instance Normalization over a 3D input (a mini-batch of 1D
    ...
    .. _`Instance Normalization: The Missing Ingredient for Fast Stylization`:
        https://arxiv.org/abs/1607.08022
    "
  [num_features & {:keys [eps momentum affine track_running_stats]
                       :or {eps 1e-05 momentum 0.1 affine false track_running_stats false}} ]
    (py/call-attr-kw instancenorm "InstanceNorm1d" [num_features] {:eps eps :momentum momentum :affine affine :track_running_stats track_running_stats }))
