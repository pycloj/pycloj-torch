(ns torch.nn.modules.CosineEmbeddingLoss
...
(defn CosineEmbeddingLoss 
  ...
  [ & {:keys [margin size_average reduce reduction]
   ...
   (py/call-attr-kw modules "CosineEmbeddingLoss" [] {:margin margin :size_average size_average :reduce reduce :reduction reduction }))
