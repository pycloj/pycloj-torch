(ns torch.nn.modules.sparse.Embedding
...
(py/initialize!)
(defonce sparse (import-module "torch.nn.modules.sparse"))
  ...
  "A simple lookup table that stores embeddings of a fixed dictionary and size.
    ...
    Examples::
        ...
        tensor([[[ 0.0000,  0.0000,  0.0000],
                 ...
                 [-0.1655,  0.9897,  0.0635]]])
    "
  [num_embeddings embedding_dim padding_idx max_norm & {:keys [norm_type scale_grad_by_freq sparse _weight]
                       :or {norm_type 2.0 scale_grad_by_freq false sparse false}} ]
    (py/call-attr-kw sparse "Embedding" [num_embeddings embedding_dim padding_idx max_norm] {:norm_type norm_type :scale_grad_by_freq scale_grad_by_freq :sparse sparse :_weight _weight }))
