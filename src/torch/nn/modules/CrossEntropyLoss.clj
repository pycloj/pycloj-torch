(ns torch.nn.modules.CrossEntropyLoss
...
(defn CrossEntropyLoss 
  ...
  [weight size_average & {:keys [ignore_index reduce reduction]
    ...
    (py/call-attr-kw modules "CrossEntropyLoss" [weight size_average] {:ignore_index ignore_index :reduce reduce :reduction reduction }))
