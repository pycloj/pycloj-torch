(ns torch.nn.modules.dropout.FeatureAlphaDropout
  ""
...
(py/initialize!)
(defonce dropout (import-module "torch.nn.modules.dropout"))

(defn FeatureAlphaDropout 
  ""
  [ & {:keys [p inplace]
       :or {p 0.5 inplace false}} ]
  
   (py/call-attr-kw dropout "FeatureAlphaDropout" [] {:p p :inplace inplace }))
