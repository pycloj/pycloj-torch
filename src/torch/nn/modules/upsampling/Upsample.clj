(ns torch.nn.modules.upsampling.Upsample
  ...
  "Upsamples a given multi-channel 1D (temporal), 2D (spatial) or 3D (volumetric) data.
    ...
    Examples::
        ...
        tensor([[[[ 1.0000,  1.4000,  1.8000,  1.6000,  0.8000,  0.0000],
                  ...
                  [ 0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000]]]])
    "
  [size scale_factor & {:keys [mode align_corners]
                       :or {mode "nearest"}} ]
    (py/call-attr-kw upsampling "Upsample" [size scale_factor] {:mode mode :align_corners align_corners }))
