(ns torch.nn.modules.flatten.Flatten
  "
...
(py/initialize!)
(defonce flatten (import-module "torch.nn.modules.flatten"))
...
(defn Flatten 
  "
    ...
    Examples::
        ...
        >>> )
    "
  [ & {:keys [start_dim end_dim]
       :or {start_dim 1 end_dim -1}} ]
  
   (py/call-attr-kw flatten "Flatten" [] {:start_dim start_dim :end_dim end_dim }))
