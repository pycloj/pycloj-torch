(ns torch.nn.modules.fold.Unfold
...
(defn Unfold 
  "Extracts sliding local blocks from a batched input tensor.
    ...
    * For the case of two input spatial dimensions this operation is sometimes
    ...
    "
  [kernel_size & {:keys [dilation padding stride]
                       :or {dilation 1 padding 0 stride 1}} ]
    (py/call-attr-kw fold "Unfold" [kernel_size] {:dilation dilation :padding padding :stride stride }))
