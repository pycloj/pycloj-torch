...
(py/initialize!)
(defonce fold (import-module "torch.nn.modules.fold"))
...
(defn Fold 
  "Combines an array of sliding local blocks into a large containing
    ...
    * For the case of two output spatial dimensions this operation is sometimes
    ...
    "
  [output_size kernel_size & {:keys [dilation padding stride]
                       :or {dilation 1 padding 0 stride 1}} ]
    (py/call-attr-kw fold "Fold" [output_size kernel_size] {:dilation dilation :padding padding :stride stride }))
