(ns torch.nn.modules.FractionalMaxPool3d
...
(defn FractionalMaxPool3d 
  ...
  [kernel_size output_size output_ratio & {:keys [return_indices _random_samples]
    ...
    (py/call-attr-kw modules "FractionalMaxPool3d" [kernel_size output_size output_ratio] {:return_indices return_indices :_random_samples _random_samples }))
