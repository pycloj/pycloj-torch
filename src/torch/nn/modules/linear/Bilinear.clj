(ns torch.nn.modules.linear.Bilinear
...
(py/initialize!)
(defonce linear (import-module "torch.nn.modules.linear"))
...
(defn Bilinear 
  "Applies a bilinear transformation to the incoming data:
    ...
    Examples::
        ...
        torch.Size([128, 40])
    "
  [in1_features in2_features out_features & {:keys [bias]
                       :or {bias true}} ]
    (py/call-attr-kw linear "Bilinear" [in1_features in2_features out_features] {:bias bias }))
...
(defn forward 
  ""
  [ self input1 input2 ]
  (py/call-attr self "forward"  self input1 input2 ))
