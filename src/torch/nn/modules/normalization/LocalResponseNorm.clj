(ns torch.nn.modules.normalization.LocalResponseNorm
...
(defn LocalResponseNorm 
  "Applies local response normalization over an input signal composed
    ...
    "
  [size & {:keys [alpha beta k]
                       :or {alpha 0.0001 beta 0.75 k 1.0}} ]
    (py/call-attr-kw normalization "LocalResponseNorm" [size] {:alpha alpha :beta beta :k k }))
