(ns torch.nn.modules.normalization.GroupNorm
...
(defn GroupNorm 
  "Applies Group Normalization over a mini-batch of inputs as described in
    ...
    .. _`Group Normalization`: https://arxiv.org/abs/1803.08494
    "
  [num_groups num_channels & {:keys [eps affine]
                       :or {eps 1e-05 affine true}} ]
    (py/call-attr-kw normalization "GroupNorm" [num_groups num_channels] {:eps eps :affine affine }))
