(ns torch.nn.modules.normalization.CrossMapLRN2d
  ""
...
(defn CrossMapLRN2d 
  ...
  [size & {:keys [alpha beta k]
                       :or {alpha 0.0001 beta 0.75 k 1}} ]
    (py/call-attr-kw normalization "CrossMapLRN2d" [size] {:alpha alpha :beta beta :k k }))
