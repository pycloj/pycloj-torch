(ns torch.nn.modules.normalization.LayerNorm
...
(py/initialize!)
(defonce normalization (import-module "torch.nn.modules.normalization"))
...
(defn LayerNorm 
  "Applies Layer Normalization over a mini-batch of inputs as described in
    ...
    .. _`Layer Normalization`: https://arxiv.org/abs/1607.06450
    "
  [normalized_shape & {:keys [eps elementwise_affine]
                       :or {eps 1e-05 elementwise_affine true}} ]
    (py/call-attr-kw normalization "LayerNorm" [normalized_shape] {:eps eps :elementwise_affine elementwise_affine }))
