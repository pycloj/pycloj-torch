(ns torch.nn.modules.batchnorm.SyncBatchNorm
...
(py/initialize!)
(defonce batchnorm (import-module "torch.nn.modules.batchnorm"))
...
(defn SyncBatchNorm 
  "Applies Batch Normalization over a N-Dimensional input (a mini-batch of [N-2]D inputs
    ...
    .. _`Batch Normalization: Accelerating Deep Network Training by Reducing Internal Covariate Shift`:
        https://arxiv.org/abs/1502.03167
    "
  [num_features & {:keys [eps momentum affine track_running_stats process_group]
                       :or {eps 1e-05 momentum 0.1 affine true track_running_stats true}} ]
    (py/call-attr-kw batchnorm "SyncBatchNorm" [num_features] {:eps eps :momentum momentum :affine affine :track_running_stats track_running_stats :process_group process_group }))
