(ns torch.nn.modules.batchnorm.sync-batch-norm
  ""
...
(defn backward 
  ""
  [ self grad_output ]
  (py/call-attr self "backward"  self grad_output ))

(defn forward 
  ""
  [ self input weight bias running_mean running_var eps momentum process_group world_size ]
  (py/call-attr self "forward"  self input weight bias running_mean running_var eps momentum process_group world_size ))
