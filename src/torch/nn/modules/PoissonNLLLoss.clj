(ns torch.nn.modules.PoissonNLLLoss
...
(defn PoissonNLLLoss 
  ...
  [ & {:keys [log_input full size_average eps reduce reduction]
   ...
   (py/call-attr-kw modules "PoissonNLLLoss" [] {:log_input log_input :full full :size_average size_average :eps eps :reduce reduce :reduction reduction }))
