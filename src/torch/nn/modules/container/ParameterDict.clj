(ns torch.nn.modules.container.ParameterDict
...
(defn ParameterDict 
  "Holds parameters in a dictionary.
    ...
    * in :meth:`~torch.nn.ParameterDict.update`, the order of the merged ``OrderedDict``
    ...
    "
  [ parameters ]
  (py/call-attr container "ParameterDict"  parameters ))
...
(defn pop 
  "Remove key from the ParameterDict and return its parameter.
        ...
        "
  [ self key ]
  (py/call-attr self "pop"  self key ))
...
(defn update 
  "Update the :class:`~torch.nn.ParameterDict` with the key-value pairs from a
        ...
        "
  [ self parameters ]
  (py/call-attr self "update"  self parameters ))
