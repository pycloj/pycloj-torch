(ns torch.nn.modules.container.ParameterList
...
(defn ParameterList 
  "Holds parameters in a list.
    ...
    "
  [ parameters ]
  (py/call-attr container "ParameterList"  parameters ))
...
(defn append 
  "Appends a given parameter at the end of the list.
        ...
        "
  [ self parameter ]
  (py/call-attr self "append"  self parameter ))
...
(defn extend 
  "Appends parameters from a Python iterable to the end of the list.
        ...
        "
  [ self parameters ]
  (py/call-attr self "extend"  self parameters ))
