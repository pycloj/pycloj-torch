...
(defn TripletMarginLoss 
  ...
  [ & {:keys [margin p eps swap size_average reduce reduction]
   ...
   (py/call-attr-kw nn "TripletMarginLoss" [] {:margin margin :p p :eps eps :swap swap :size_average size_average :reduce reduce :reduction reduction }))
