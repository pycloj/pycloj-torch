(ns torch.nn.qat.modules.linear.Linear
  "
...
(py/initialize!)
(defonce linear (import-module "torch.nn.qat.modules.linear"))
...
(defn Linear 
  ...
  [in_features out_features & {:keys [bias qconfig]
                       :or {bias true}} ]
    (py/call-attr-kw linear "Linear" [in_features out_features] {:bias bias :qconfig qconfig }))
