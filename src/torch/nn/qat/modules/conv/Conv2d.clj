(ns torch.nn.qat.modules.conv.Conv2d
  "
...
(py/initialize!)
(defonce conv (import-module "torch.nn.qat.modules.conv"))
...
(defn Conv2d 
  "
    ...
    Attributes:
        ...
        weight_fake_quant: fake quant module for weight
    "
  [in_channels out_channels kernel_size & {:keys [stride padding dilation groups bias padding_mode qconfig]
                       :or {stride 1 padding 0 dilation 1 groups 1 bias true padding_mode "zeros"}} ]
    (py/call-attr-kw conv "Conv2d" [in_channels out_channels kernel_size] {:stride stride :padding padding :dilation dilation :groups groups :bias bias :padding_mode padding_mode :qconfig qconfig }))
