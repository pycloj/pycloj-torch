(ns torch.nn.qat.modules.Conv2d
  "
...
(py/initialize!)
(defonce modules (import-module "torch.nn.qat.modules"))
...
(defn Conv2d 
  ...
  [in_channels out_channels kernel_size & {:keys [stride padding dilation groups bias padding_mode qconfig]
    ...
    (py/call-attr-kw modules "Conv2d" [in_channels out_channels kernel_size] {:stride stride :padding padding :dilation dilation :groups groups :bias bias :padding_mode padding_mode :qconfig qconfig }))
